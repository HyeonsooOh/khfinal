...
public class ReserveController {
	...
	public String selectDay(@ModelAttribute MultiCategory multiList,
		...
		//System.out.println("1234 : "+multiList);
		if(multiList.getMultiList() != null) {
			multiCategory = multiList;
			//System.out.println("multiCategory : "+multiCategory);
			//System.out.println("size : "+multiCategory.getMultiList().size());
	...
	public String selectDay(@ModelAttribute MultiRepair multiList,
		...
		if(multiList.getMultiList() != null) {
			...
			//System.out.println("multiRepair : "+multiRepair);
	...
	public String insertReserve(@ModelAttribute Reserve reserve,
		...
		//System.out.println("request : "+reserve.getRequest());
		//System.out.println("resType : "+reserve.getResType());
		//System.out.println("pickupDate : "+reserve.getPickupDate());
		//System.out.println("delDate : "+reserve.getDelDate());
		...
		if(reserve.getResType().equals("세탁")) {
			...
			if(multiCategory.getMultiList() != null) { //세탁의 값들이 있을때
				...
				if(result>0) { // 성공시 그 예약번호 select해서 예약번호가져오기
					...
					//Reserve r = reserveService.selectReserve(reserve);
					
					if(res != null) { // 성공시 예약번호를 제대로 가져왔을 때
						//System.out.println("rNum : "+res.getResNum());
