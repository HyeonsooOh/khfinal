  ...
  <body>
    ...
    <div class="find_container">
      ...
      <div class="find_form_container" align="center">
        ...
        <div class="find_btns" align="center">
          <button class="btn btn-primary" id="btnFindId" disabled type="submit">
            아이디 찾기
          </button>
        </div>
      </div>
    ...
    <script>
      $(function () {
        ...
        function invokeAuth() {
          console.log("i am in invoke auth");
              ...
              $.ajax({
                ...
                success: function (result) {
                  if (result != "N") {
                    ...
                    $.ajax({
                      url: "${ pageContext.request.contextPath }/validate/emailId.do",
                      type: "get",
                      data: { email: $emailMerge, id: idInSearch },
                      success: function (result) {
                        if (result == true) {
                          alert("회원님의 메일로 아이디를 보내드렸습니다.");
                        } else {
