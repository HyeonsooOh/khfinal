        ...
        <div class="main">
            ...
            <fieldset class="select">
                ...
                <div class="selectMenu">
                    ...
                    <form action="${pageContext.request.contextPath }/subscribe/subqc.sb" style="height:70%; width:100%;" >
                    <div id="ck-button">
                        <label>
                            <input type="radio" name="subDay" value="월요일" onclick="onlyDay(this);" id="mon"><span>월요일</span> 
                        </label> 
                        <label>
                            <input type="radio" name="subDay" value="화요일" onclick="onlyDay(this);" id="tue"><span>화요일</span> 
                        </label> 
                        <label>
                            <input type="radio" name="subDay" value="수요일" onclick="onlyDay(this);" id="wed"><span>수요일</span>
                        </label> 
                        <label>
                            <input type="radio" name="subDay" value="목요일" onclick="onlyDay(this);" id="thu"><span>목요일</span>
                        </label>
                        <label>
                            <input type="radio" name="subDay" value="금요일" onclick="onlyDay(this);" id="fri"><span>금요일</span> 
                        </label> 
                        <label>
                            <input type="radio" name="subDay" value="토요일" onclick="onlyDay(this);" id="sat"><span>토요일</span>
                        </label>
                        <label>
                            <input type="radio" name="subDay" value="일요일" onclick="onlyDay(this);" id="sun"><span>일요일</span>
                        </label>
                        ...
                        <input type='hidden' value="${ subEdate }" name="subEdate">
                        <input type="submit" value="다음 단계"class="nextstep2">
    ...
    <script>
        $(function () {
            ...
            switch(day) {
                ...
                $("#mon").click(function() {
                    var result = window.confirm("이미 선택한 날짜입니다. 그래도 선택하시겠습니까?");
                    if(result) {
