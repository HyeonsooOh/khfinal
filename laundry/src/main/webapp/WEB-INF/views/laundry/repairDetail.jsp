                ...
                <div class="selectMenu">
                	<form action="${pageContext.request.contextPath}/reserve/repairDay.rs" style="height:16%;" method="post">
	                    <div class="serviceMenu">
	                        ...
	                        <div id="insert" style="text-align:left"> 
	                            <span style="font-size: 7px; margin-left:10px;">수선종류</span>
	                            <span style="font-size: 7px;">기장수선</span>
	                            <span style="font-size: 7px;">통수선</span>
	                            <span style="font-size: 7px;">재박음질</span>
	                            <span style="font-size: 7px;">지퍼/단추수선</span>
	                            <span style="font-size: 7px;">금액</span>
	                            <br>
	                        </div>
	                    </div>
                    ...
                    <div class="laundryPrice1">
                        <table class="priceTable">
                            ...
                            <tr>
                                <td height="30" align="left">기장수선</td>
                                <td align="right">3000</td>
                            </tr>
                            <tr>
                                <td height="30" align="left">통수선</td>
                                <td align="right">5000</td>
                            </tr>
                            <tr>
                                <td height="30" align="left">재박음질</td>
                                <td align="right">5000</td>
                            </tr>
                            <tr>
                                <td height="30" align="left">지퍼/단추수선</td>
                                <td align="right">5000</td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <script>
        ...
        function insertPants() {
            ...
            if(repair1.length != 0) {
                ...
                document.getElementById('insert').innerHTML += "<div id='reset"+num+"''> <input type='text' value="+pants+" style='width:10%; margin-left:3%;' name='multiList["+num+"].rcategory'>"
                                                                        +"<input type='text' value="+length+" style='width:5%; margin-left:3.5%;' name='multiList["+num+"].lengthYN'>"
                                                                        +"<input type='text' value="+width+" style='width:5%; margin-left:3.5%;' name='multiList["+num+"].widthYN'>"
                                                                        +"<input type='text' value="+reseal+" style='width:5%; margin-left:5%;' name='multiList["+num+"].resealYN'>"
                                                                        +"<input type='text' value="+zip+" style='width:5%; margin-left:7%;'  name='multiList["+num+"].zipYN'>"
                                                                        +"<input type='text' value="+price+" style='width:12%; margin-left:7%;'  name='multiList["+num+"].rPrice'>"
        ...
        function insertShirts() {
            ...
            if(repair1.length != 0) {
                ...
                document.getElementById('insert').innerHTML += "<div id='reset"+num+"'> <input type='text' value="+shirts+" style='width:10%; margin-left:3%;' name='multiList["+num+"].rcategory'>"
													                +"<input type='text' value="+length+" style='width:5%; margin-left:3.5%;' name='multiList["+num+"].lengthYN'>"
													                +"<input type='text' value="+width+" style='width:5%; margin-left:3.5%;' name='multiList["+num+"].widthYN'>"
													                +"<input type='text' value="+reseal+" style='width:5%; margin-left:5%;' name='multiList["+num+"].resealYN'>"
													                +"<input type='text' value="+zip+" style='width:5%; margin-left:7%;'  name='multiList["+num+"].zipYN'>"
        ...
        function insertJacket() {
            ...
            if(repair1.length != 0) {
                ...
                document.getElementById('insert').innerHTML += "<div id='reset"+num+"'> <input type='text' value="+jacket+" style='width:10%; margin-left:3%;' name='multiList["+num+"].rcategory'>"
														                +"<input type='text' value="+length+" style='width:5%; margin-left:3.5%;' name='multiList["+num+"].lengthYN'>"
														                +"<input type='text' value="+width+" style='width:5%; margin-left:3.5%;' name='multiList["+num+"].widthYN'>"
														                +"<input type='text' value="+reseal+" style='width:5%; margin-left:5%;' name='multiList["+num+"].resealYN'>"
														                +"<input type='text' value="+zip+" style='width:5%; margin-left:7%;'  name='multiList["+num+"].zipYN'>"
