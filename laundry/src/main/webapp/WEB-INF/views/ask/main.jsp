                ...
                $(".box_wrap>li .items").click(function(){
                   ...
                   if($p.css("display") == "none"){
	   					...
	   					if($(this).attr("id") == "items1") {
	   						...
	   						$("#faqTitle").text("결제 정보 수정");
	   						$("#faqContent").text("관리자에게 물어보세요.");
	   					} else if($(this).attr("id") == "items3") {
	   						$("#faqTitle").text("회원 탈퇴");
	   						$("#faqContent").text("현재 회원 탈퇴는 지원하지 않습니다.");
	   					} else if($(this).attr("id") == "items4") {
	   						$("#faqTitle").text("인증 메일");
	   						$("#faqContent").text("이메일이 늦게 수신되거나 해당 이메일이 휴면 상태일 수 있습니다");
	   					} else if($(this).attr("id") == "items5") {
	   						$("#faqTitle").text("결제 에러");
	   						$("#faqContent").text("캐시를 삭제하고 브라우저를 재시작해주세요");
	   					}
	...
	<div id="foot">
		<div class="aba">
			...
			<div class="foot-body">
				<ol class="bab">
					<li>
						<a href="${pageContext.request.contextPath}/ask/board.do?category=${ askType="계정관리" }">
						<div class="box">
							<p>계정관리</p>
						</div>
						</a>
					...
					<li>
						<a href="${pageContext.request.contextPath}/ask/board.do?category=${ askType="서비스" }">
						<div class="box">
							<p>서비스</p>
						</div>
						</a>
					...
					<li>
						<a href="${pageContext.request.contextPath}/ask/board.do?category=${ askType="구독"}">
						<div class="box">
							<p>구독</p>
						</div>
						</a>
					...
					<li>
						<a href="${pageContext.request.contextPath}/ask/board.do?category=${ askType="결제/환불" }">
						<div class="box">
							<p>결제 / 환불</p>
						</div>
						</a>
					...
					<li>
						<a href="${pageContext.request.contextPath}/ask/board.do?category=${ askType="기타" }">
						<div class="box">
							<p>기타</p>
						</div>
						</a>
